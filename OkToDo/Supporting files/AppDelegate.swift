...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "OkToDo")
...
extension AppDelegate {
    private func setupFirstData() {
        ...
        guard let dataPath = Bundle.main.path(forResource: "data", ofType: "plist"),
              let dataArray = NSArray(contentsOfFile: dataPath) else { return }
